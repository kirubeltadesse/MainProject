...
- Since the test result for a single website return a huge amount of information ($\approx$ 3MB of text data) in the next function I select the neccessory parameters out of the result and save the result to a file. 
